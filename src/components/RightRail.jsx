    ...
    <aside className="rail">
      ...
      <div>
        ...
        <div className="staff-row">
          ...
          <div><div className="staff-name">R. Kapoor</div><div className="staff-role">Gate B Supervisor</div></div>
          <span className="status-chip on"></span>
        </div>
        <div className="staff-row">
          <div className="staff-avatar">MT</div>
          <div><div className="staff-name">M. Tan</div><div className="staff-role">Medical Lead</div></div>
          <span className="status-chip busy"></span>
        </div>
        <div className="staff-row">
          <div className="staff-avatar">AV</div>
          <div><div className="staff-name">A. Verma</div><div className="staff-role">Crowd Marshal</div></div>
          <span className="status-chip on"></span>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="weather-block">
          ...
          <div className="weather-item"><div className="wl">19:00</div><div className="wv">27°</div></div>
          <div className="weather-item"><div className="wl">20:00</div><div className="wv">26°</div></div>
          <div className="weather-item"><div className="wl">21:00</div><div className="wv">25°</div></div>
        </div>
      </div>
    </aside>
  );
