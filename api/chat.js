...
import { buildSystemInstruction } from '../src/data/prompt.js';
...
export default async function handler(req, res) {
  ...
  const apiKey = process.env.GEMINI_API_KEY || process.env.VITE_GEMINI_API_KEY || process.env.VITE_GEMINI_KEY || process.env.GEMINI_KEY;
  ...
  const systemInstructionText = buildSystemInstruction(state);
